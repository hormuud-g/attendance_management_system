...
// ✅ Fetch ALL campuses for filter dropdown and checkboxes
$campuses = $pdo->query("SELECT campus_id, campus_name, campus_code, address, status FROM campus ORDER BY campus_name ASC")->fetchAll(PDO::FETCH_ASSOC);
...
$inactive_faculties = $pdo->query("SELECT COUNT(*) FROM faculties WHERE status='inactive'")->fetchColumn();

// ✅ Get faculties per campus count
$facultiesPerCampus = $pdo->query("
    ...
    <form method="POST" enctype="multipart/form-data" id="addForm" onsubmit="return validateAddForm()">
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <textarea id="office_address" name="office_address" class="form-control" rows="2"></textarea>
        </div>
                ...
                <label for="campus_<?= $c['campus_id'] ?>" style="cursor: pointer;">
                  ...
                  <div class="campus-info">
                    ...
                    <?php if(!empty($c['address'])): ?>
                      | Address: <?= htmlspecialchars($c['address']) ?>
                    <?php endif; ?>
    ...
    <form method="POST" enctype="multipart/form-data" id="editForm" onsubmit="return validateEditForm()">
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <textarea id="edit_office" name="office_address" class="form-control" rows="2"></textarea>
        </div>
