...
<div class="modal" id="editModal">
  <div class="modal-content">
    ...
    <form method="POST" enctype="multipart/form-data">
      ...
      <div><label>Gender</label><select id="edit_gender" name="gender"><option>Male</option><option>Female</option></select></div>
...
function openEditModal(id,name,email,phone,gender,qual,pos,status){
  openModal('editModal');
  edit_id.value=id; edit_name.value=name; edit_email.value=email;
  edit_phone.value=phone; edit_gender.value=gender;
  edit_qual.value=qual; edit_pos.value=pos; edit_status.value=status;
}
